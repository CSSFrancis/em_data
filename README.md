...
This is a simple project for aggregating different Electron Micrscopy Files which are hosted over different sources.  It uses pooch to download datasets and should be 
